...
class AnnotationPositionValueTest extends BaseTestCase
{
    ...
    {
        $paramTest = AnnotationPositionValueFixture::createFromVarMap(new ArrayVarMap($input));
...
class AnnotationPositionValueFixture implements DataType
{
    use CreateFromVarMap;
    use GetInputTypesFromAttributes;

    public function __construct(
        #[AnnotationPositionValue('position_input')]
