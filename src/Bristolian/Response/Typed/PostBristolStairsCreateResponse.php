...
//   Path: /api/bristol_stairs_create
//   Method: POST
// 
 ...
 * @codeCoverageIgnore
 */
class PostBristolStairsCreateResponse implements StubResponse
{
    private string $body;

    /**
     * @param BristolStairInfo $stair_info
     */
    public function __construct(BristolStairInfo $stair_info)
    {
        ...
        $converted_data['stair_info'] = $converted_stair_info;
