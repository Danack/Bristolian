...
class StandardBristolStairImageStorageProcessor implements BristolStairImageStorageProcessor
{
    public function __construct(
        private BristolStairImageStorageInfoRepo $fileStorageInfoRepo,
    ) {
    }
