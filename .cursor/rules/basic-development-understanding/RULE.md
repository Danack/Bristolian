...
- If you need to invoke a tool please read the files in @notes.
- If you are writing any code, or running any scripts, read the document @notes/developing/development_setup.md.
- If you are writing tests, read @notes/developing/testing_guidelines.md first.
...
- If you are doing any coding, read the document @notes/developing/testing_guidelines.md to learn how to run the tests. For running all code quality tools before finalising work, see the finalise_work command.
...
- If you are writing front end code, read the document @notes/developing/front_end_design_rules.md
