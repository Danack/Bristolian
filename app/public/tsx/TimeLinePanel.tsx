...
function getDefaultState(/*initialControlParams: object*/): TimeLinePanelState {
    return {
        // max_comment_id: null,
        // TimeLine: [],
        // last_error: null
...
export class TimeLinePanel extends Component<TimeLinePanelProps, TimeLinePanelState> {
    ...
    render(props: TimeLinePanelProps, state: TimeLinePanelState) {
